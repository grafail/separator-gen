...
public class SeparatorRepairAction extends AnAction {

  public SeparatorRepairAction() {
    super();
  }
  ...
  public void actionPerformed(@NotNull AnActionEvent event) {
    ...
    if (editor != null && pf != null) {
      ...
      String text;
      if (selectionModel.hasSelection() && (text = selectionModel.getSelectedText()) != null) {
        String repairedLine = SeparatorGenerator.repairSeparator(text, pf.getLanguage(), lineLength, innerLineStyle);
